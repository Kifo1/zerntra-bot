...
import static de.kifo.common.enums.button.ButtonType.TOGGLE_PLAYING_TO_ON;
import static java.util.Objects.isNull;

@ButtonBase.BotButton(buttonType = TOGGLE_PLAYING_TO_ON)
public class ToggleSongPlayToOnButton extends ButtonBase {

    public ToggleSongPlayToOnButton(BotButton botButton) {
        super(botButton);
    }
    ...
    public void onClick(ButtonInteractionEvent event) {
        ...
        event.getMessage().editMessageComponents(buttonService.getSongActionRow(true)).queue();
